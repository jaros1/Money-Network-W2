(function () {
    ...
    //    var pgm = '60-test.js createNewWallet: ' ;
    //    console.log(pgm + 'createNewWallet: ');
    //    console.log(pgm + 'walletid = ' + walletid);
    //    console.log(pgm + 'walletpwd = ' + walletpwd);
    //    console.log(pgm + 'err = ' + CircularJSON.stringify(err));
    //    console.log(pgm + 'wallet = ' + CircularJSON.stringify(wallet));
    //    console.log(pgm + 'backupInfo = ' + CircularJSON.stringify(backupInfo));
    //    //backupInfo = {
    //    //    "walletVersion": "v3",
    ...
    //    wallet.deleteWallet(
    //        function () {
    //            var pgm = '60-test.js deleteWalletOK: ' ;
    //            console.log(pgm + 'arguments.length = ' + arguments.length);
    //            for (i = 0; i < arguments.length; i++) console.log(pgm + 'arguments[' + i + '] = ' + CircularJSON.stringify(arguments[i]));
    //            // deleteWalletOK: arguments.length = 2
    //            // all.js:69845 arguments[0] = null
    //            // all.js:69845 arguments[1] = true
    //        },
    //        function (args) {
    //            var pgm = '60-test.js deleteWalletError: ' ;
    //            console.log(pgm + 'arguments.length = ' + arguments.length);
    //            for (i = 0; i < arguments.length; i++) console.log(pgm + 'arguments[' + i + '] = ' + CircularJSON.stringify(arguments[i]));
    //        }
    //    );
